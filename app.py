...
login_manager.login_view = 'login'  # 用户访问权限不够时重定向到登录页面
...
@click.option('--password', prompt=True, hide_input=True, confirmation_prompt=True, help='The passward used to login.')
